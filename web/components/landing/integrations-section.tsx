...
const integrations = [
  { name: "Unlink Protocol", category: "Privacy Layer" },
  { name: "Base", category: "L2 Network" },
  { name: "USDC", category: "Stablecoin" },
  { name: "ENS", category: "Identity" },
  { name: "Privy", category: "Auth" },
  { name: "Viem", category: "Web3 SDK" },
  { name: "Safe", category: "Multi-sig" },
  { name: "Permit2", category: "Token Approvals" },
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">
            Privacy infrastructure, identity, and payments — all composable and production-ready.
          </p>
        </div>
      </div>
