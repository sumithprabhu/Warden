...
const metrics = [
  {
    ...
    suffix: "",
    prefix: "",
    label: "Salary data points leaked on-chain",
    displayOverride: "0",
  },
  {
    value: 100,
    suffix: "%",
    prefix: "",
    label: "Private settlement via ZK proofs",
  },
  {
    value: 1,
    suffix: "",
    prefix: "",
    label: "Transaction to pay entire team",
  },
  {
    value: 60,
    suffix: "s",
    prefix: "<",
    label: "Average payroll settlement time",
  },
];
